"""
Django settings for midfield project.
...
SECRET_KEY = "django-insecure-+*s6buw(*=2&_e+mgkga84^-)y6n^ki!n_+)=6r20o1l03=0fr"
...
WSGI_APPLICATION = "midfield.wsgi.application"
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'google_auth.pipeline.save_profile',  # Custom step to save profile data
)
